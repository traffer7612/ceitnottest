...
- [Механика ликвидации](LIQUIDATION.md)
- [Смарт-контракты и адреса](SMART-CONTRACTS.md)

## Безопасность

- [Аудит безопасности (тесты, Slither, исправления)](SECURITY-AUDIT.md)
- [Slither — как запустить и отчёты](SLITHER.md)
- [Bug Bounty](BUG-BOUNTY.md)

## Разработка и деплой

- [Архитектура проекта](ARCHITECTURE.md)
- [Деплой контрактов](DEPLOY.md)
- [Деплой фронта на Vercel](VERCEL.md)
